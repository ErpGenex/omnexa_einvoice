...
from omnexa_einvoice.ei_gap_register import get_gap_status
from omnexa_einvoice.ei_global_benchmark import get_global_ei_score

@frappe.whitelist()
def export_ei_global_audit() -> dict:
	root = os.path.join(get_bench_path(), "Docs", "2026-06-06_OMNEXA_EINVOICE_GLOBAL_AUDIT")
	os.makedirs(root, exist_ok=True)
	score, gaps = get_global_ei_score(), get_gap_status()
