...
def execute(filters=None):
	data = frappe.db.sql(
		"""
		SELECT `name`, `company`, `branch`, `reference_name`, `document_type`, `status`
		FROM `tabZATCA Submission Log`
	...
	columns = [
		...
		{"label": _("Document Type"), "fieldname": "document_type", "fieldtype": "Select", "width": 120},
