...
def execute(filters=None):
	data = frappe.db.sql(
		"""
		SELECT `name`, `company`, `branch`, `country_code`, `reference_name`, `status`
		FROM `tabCountry Tax Submission Log`
	...
	columns = [
		...
		{"label": _("Country Code"), "fieldname": "country_code", "fieldtype": "Data", "width": 120},
		{"label": _("Reference"), "fieldname": "reference_name", "fieldtype": "Data", "width": 120},
